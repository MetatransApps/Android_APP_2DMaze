...
public class Entity2D_Ground_Wall_Labyrinths extends Entity2D_Terrain_Labyrinths {
	
	
	private static final long serialVersionUID = -9092028927106771746L;


	public Entity2D_Ground_Wall_Labyrinths(IWorld world, RectF _evelop, int _index_x, int _index_y) {
